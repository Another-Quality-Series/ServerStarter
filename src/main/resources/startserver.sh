...
if [ -f serverstarter-@@serverstarter-libVersion@@.jar ]; then
    ...
    export URL="https://github.com/Another-Quality-Series/ServerStarter/releases/download/v@@serverstarter-libVersion@@/serverstarter-@@serverstarter-libVersion@@.jar"
fi
echo $URL
which wget >> /dev/null
if [ $? -eq 0 ]; then
